#ifndef SUPERPLAYER_COMMONTOOLS_H
#define SUPERPLAYER_COMMONTOOLS_H
#include <jni.h>
...
//static inline UINT64_C getCurrentTimeReal()
//{
//   struct timeval tv;
//   gettimeofday(&tv,NULL);
...
inline long getFileSize(FILE* pFile) {
	fseek(pFile, 0, SEEK_END);
	return ftell(pFile);
}

#endif //SUPERPLAYER_COMMONTOOLS_H
